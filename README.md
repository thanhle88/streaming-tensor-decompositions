...
A list of up-to-date and on-going research papers on streaming, adaptive, online, incremental tensor decompositions, tensor tracking, and dynamic tensor analysis. (My old version up to 2023 is [here](https://github.com/thanhtbt/tensor_tracking_survey))
...
* **TT-ROTC**: "Robust Streaming Tensor Train Completion for Dynamic Space-based Spectrum Situation Map Construction", in **IEEE ICC**, 2026, [Paper](https://ieeexplore.ieee.org/abstract/document/11587379/)
...
* **TOUCAN**: "Grassmannian optimization for online tensor completion and tracking with the T-SVD", in **IEEE Trans. Signal Process.**, 2022, [Paper](https://ieeexplore.ieee.org/abstract/document/9756209), [PDF](https://arxiv.org/abs/2001.11419), [Code](https://github.com/kgilman/TOUCAN)
...
* **FOCAL**: "Fast and Accurate Online Coupled Matrix-Tensor Factorization via Frequency Regularization", in **KDD**, 2026, [Paper](https://yongchanpark.github.io/resources/2026/KDD/FOCAL.pdf), [Matlab](https://github.com/snudatalab/FOCAL)
